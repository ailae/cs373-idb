...
class Artist(db.Model) :
	...
	genre = db.Column(db.String, ForeignKey('Genre.name'), nullable=False)
	popularity = db.Column(db.Integer, nullable=False)
	top_tracks = db.Column(db.String)
	spotify_url = db.Column(db.String(150), nullable=False)

	def __init__(self, name, image_url, genre,  \
	...
	def __repr__(self) :
		return 'Artist(name={}, image_url={}, genre={}, '.format(
				...
				'popularity={}, topTracks={}, spotifyUrl={})'.format(
					self.popularity,
					self.topTracks,
					self.spotifyUrl
				)
...
class Year(db.Model) :
	...
	top_song = db.Column(db.String(50), nullable=False)
	top_genre = db.Column(db.String(50), nullable=False)
...
class Genre(db.Model) :
	...
	year_1 = db.Column(db.Integer, ForeignKey('Year.year'))
	...
	def __repr__(self) :
		return 'Genre=(name={}, year_1={}, description={}, '.format(
					self.name,
					self.year_1,
					self.description
					)
				# 	 + 
				# 'artists={}, related_genres={})'.format(
				# 	self.artists,
				# 	self.related_genres
				# 	)
